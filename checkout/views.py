...
from products.contexts import purchase_content
...
def checkout(request):
    ...
    if request.method == 'POST':
            ...
            for item_id, item_data in purchase.items():
                try:
                    ...
                    messages.error(request, (
                        "One of the products in your purchase wasn't found in our database. "
        ...
        purchase = request.session.get('purchase', {})
        if not purchase:
            messages.error(request, "There's nothing in your purchase at the moment")
            return redirect(reverse('products'))

        current_purchase = purchase_content(request)
